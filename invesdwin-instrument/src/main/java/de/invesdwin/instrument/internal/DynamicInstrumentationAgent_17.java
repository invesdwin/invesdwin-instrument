...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_17 {
    //CHECKSTYLE:ON

    private static final String UUID = "17";

    private DynamicInstrumentationAgent_17() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_17.class.getPackage().getName() + ".AgentInstrumentationInitializer");
