...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_25 {
    //CHECKSTYLE:ON

    private static final String UUID = "25";

    private DynamicInstrumentationAgent_25() {
    }
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_25.class.getPackage().getName() + ".AgentInstrumentationInitializer");
