...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_14 {
    //CHECKSTYLE:ON

    private static final String UUID = "14";

    private DynamicInstrumentationAgent_14() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_14.class.getPackage().getName() + ".AgentInstrumentationInitializer");
