...
public final class DynamicInstrumentationAgent_13 {
    ...
    private static final String UUID = "13";

    private DynamicInstrumentationAgent_13() {
    }
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_13.class.getPackage().getName() + ".AgentInstrumentationInitializer");
