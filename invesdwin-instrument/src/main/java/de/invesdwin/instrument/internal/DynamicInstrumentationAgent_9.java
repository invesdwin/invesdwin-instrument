...
public final class DynamicInstrumentationAgent_9 {
    ...
    private static final String UUID = "9";

    private DynamicInstrumentationAgent_9() {
    }
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_9.class.getPackage().getName() + ".AgentInstrumentationInitializer");
