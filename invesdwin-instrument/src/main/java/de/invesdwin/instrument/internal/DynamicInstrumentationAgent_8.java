...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_8 {
    //CHECKSTYLE:ON

    private static final String UUID = "8";

    private DynamicInstrumentationAgent_8() {
    }
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_8.class.getPackage().getName() + ".AgentInstrumentationInitializer");
