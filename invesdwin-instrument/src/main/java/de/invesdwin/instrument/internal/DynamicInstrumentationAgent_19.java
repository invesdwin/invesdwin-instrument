...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_19 {
    //CHECKSTYLE:ON

    private static final String UUID = "19";

    private DynamicInstrumentationAgent_19() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_19.class.getPackage().getName() + ".AgentInstrumentationInitializer");
