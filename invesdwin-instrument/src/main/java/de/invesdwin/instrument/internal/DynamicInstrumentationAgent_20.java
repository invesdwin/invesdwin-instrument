...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_20 {
    //CHECKSTYLE:ON

    private static final String UUID = "20";

    private DynamicInstrumentationAgent_20() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_20.class.getPackage().getName() + ".AgentInstrumentationInitializer");
