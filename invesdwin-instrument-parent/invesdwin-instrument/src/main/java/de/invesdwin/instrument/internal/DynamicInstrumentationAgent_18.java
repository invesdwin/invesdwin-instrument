...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_18 {
    //CHECKSTYLE:ON

    private static final String UUID = "18";

    private DynamicInstrumentationAgent_18() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_18.class.getPackage().getName() + ".AgentInstrumentationInitializer");
