...
// CHECKSTYLE:OFF
// @Immutable
public final class DynamicInstrumentationAgent_15 {
    //CHECKSTYLE:ON

    private static final String UUID = "15";

    private DynamicInstrumentationAgent_15() {}
    ...
    public static void premain(final String args, final Instrumentation inst) throws Exception {
        ...
        final Class<?> agentInstrumentationInitializer = agentClassLoader.loadClass(
                DynamicInstrumentationAgent_15.class.getPackage().getName() + ".AgentInstrumentationInitializer");
